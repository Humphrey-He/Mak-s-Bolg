...
export const posts: Post[] = [
  {
    ...
    content: { zh: "## 概述\n\nGo 缓存系统实现细节...", en: "## Overview\n\nGo cache implementation details..." },
    date: "2026-04-18",
    tag: "Go / Cache",
    read: "12 min",
    featured: true
  ...
  },
  {
    ...
    content: { zh: "## 概述\n\nAPISIX 插件设计...", en: "## Overview\n\nAPISIX plugin design..." },
    date: "2026-04-08",
    tag: "Gateway",
    read: "14 min"
  },
...
export function getRelatedPosts(currentPost: Post, count: number = 3): Post[] {
  return posts
    .filter((post) => post.id !== currentPost.id && post.tag === currentPost.tag)
    .slice(0, count);
}
